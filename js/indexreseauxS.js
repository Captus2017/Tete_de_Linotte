...
var initialSlide = $('.slides-container02 [data-order="1"]');
var initalSelected = $('.slide-navigation__txt02 [data-order="1"]');
...
function activate_slide(order){
  ...
  var unactiveSlide = $('.slide02.active');
  var activeSlide = $('.slides-container02 [data-order="'+order+'"]');
...
$('.slide-navigation__txt02 span').on('click', function(){
  
  var _this = $(this);
  var order = _this.data('order');
  var spans = $('.slide-navigation__txt02 span');
...
function stagger_squares(order, current) {
  var mq = 0.7;
  var moveY;
  var squares = $('.slide-navigation__squares02 .square02');
